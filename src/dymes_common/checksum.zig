//! Checksum support.
//!
// SPDX-FileCopyrightText: Copyright © 2024 TigerBeetle, Inc. All Rights Reserved.
//
// SPDX-License-Identifier: Apache-2.0
//
// -------------------------------------------------------
// ATTRIBUTION:
// Vendored from TigerBeetle to maintain hash stability.
// -------------------------------------------------------
//
...
const Aegis128LMac_128 = @import("stdx/aegis.zig").Aegis128LMac_128;
